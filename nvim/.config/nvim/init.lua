...
--- Neotree
vim.keymap.set("n", "<leader>b", ":Neotree toggle float<CR>", { desc = "Toggle Neotree floating" })
vim.keymap.set("n", "<leader>B", ":Neotree toggle left<CR>", { desc = "Toggle Neotree on left" })
